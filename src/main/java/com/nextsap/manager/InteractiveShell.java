...
public class InteractiveShell {
    ...
    private void command2(String[] args, boolean useWindows) {
        String error = """
                    ...
                    ${reset}|    - jwt.secret                     ${red}Requis${yellow}
                    ${reset}|    - spring.datasource.username     ${red}Requis${yellow}
                    ${reset}|    - spring.datasource.password     ${red}Requis${yellow}
                    ${reset}|    
                    ${reset}| ${yellow}INFO: Exemple d'utilisation:
                    ${reset}|    ${yellow}2 jwt.secret=secret spring.datasource.username=root spring.datasource.password=root
                    ${reset}|                     
        ...
        util.exec("docker-compose up -d --build " + operator + " " + sleepCommand + " 5 " + operator + " docker exec paymybuddy-vault vault login 00000000-0000-0000-0000-000000000000 " + operator + " " + sleepCommand + " 2 " + operator + " docker exec paymybuddy-vault vault kv put secret/paymybuddy " + args[1] + " " + args[2] + " " + args[3], true, 0);
    }
